 ...
 */
public class ZhihuHttpClientStack implements HttpStack {
    protected final HttpClient mClient;
    private HttpContext httpContext;

    private final static String HEADER_CONTENT_TYPE = "Content-Type";

    public ZhihuHttpClientStack(HttpClient client) {
        this(client, null);
    }

    public ZhihuHttpClientStack(HttpClient client, CookieStore cookieStore) {
        mClient = client;
        if (cookieStore == null) {
            return;
        } else {
    ...
    public HttpResponse performRequest(Request<?> request,
        ...
        HttpResponse response = mClient.execute(httpRequest, httpContext);
        return response;
    }
