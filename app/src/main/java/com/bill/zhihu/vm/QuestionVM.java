...
import com.bill.zhihu.model.question.QuestionModel;
...
public class QuestionVM {
    ...
    public QuestionVM(QuestionViewBinding binding, Activity activity, String questionId) {
    ...
    public void loadQuestion() {
        model.loadQuestion(questionId)
                .zipWith(model.loadAnswers(questionId), new Func2<QuestionResponse, AnswersResponse, Void>() {
                    @Override
    ...
    public void loadMoreAnswers() {
        ...
        model.loadAnswersNext(questionId, questionItems.size())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Subscriber<AnswersResponse>() {
                    @Override
                    public void onCompleted() {
